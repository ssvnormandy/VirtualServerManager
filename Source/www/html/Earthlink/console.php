  	...
  	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  		<div class="container-fluid">
  			<div class="navbar-header">
  				...
  				<a class="navbar-brand" href="#">Bug</a>
  			</div>
  	...
  	<div class="container-fluid">
  		...
  		<div class="row row-offcanvas row-offcanvas-left">
            ...
            <li><a href="buy.php">Buy Now</a></li>
  			...
  			<!--/span-->
                <div class="console">
                  <h3>Click on the blue bar to get focus on the server console</h3>
                  <div>
                    <object type="text/html" data="scripts/console.php" width="720px" height="430px">
                    </object>
                  </div>
